...
|Induction from [Combining induction and transduction](https://arxiv.org/pdf/2411.02272)                                 | ✓         | ✓         |           | Program-synthesis style induction                            | Neural model generates candidate Python programs matching example pairs and runs a consistent one on the test input.                                                                                                                                                                                            |
|Transduction from [Combining induction and transduction](https://arxiv.org/pdf/2411.02272)                              | ✓         |           | ?         | Direct transduction;          | Neural model directly maps example pairs + test input to a predicted output grid without constructing an explicit program                                                                                                                                   |
